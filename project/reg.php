...
<div class="conatiner ">
    ...
    <h1 class="text-center mt50 h1">立即注册,尽享丝滑</h1>
    <hr>

    <form action="./com/regdo.php" method="post" class="form-horizontal col-md-5 col-md-offset-3 h4">
        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
                ...
                <span>* 以字母开头,4-16个字符,由数字字母下划线组成</span>
            </div>
        </div>
