        ...
        <?php if(@$_GET['a'] == 'choice') {
            ...
            <?php    foreach ($arr as  $val) {  ?>
                          <tr>
                            ...
                            <th><a href="./ordergoodsdo.php?add=old&address_id=<?php echo $val['id'] ?>">选择</a></th>
                            <th><a href="./address.php?add=del&address_id=<?php echo $val['id'] ?>">删除</a></th>
                          </tr><?php }?> 
                     </table>
                    </form>
              <?php }else{ ?>
                      <form class="form-horizontal" action="./ordergoodsdo.php?add=new&address_id=<?php echo $val['id'] ?>" method="post">
