...
<nav class="navbar navbar-default">
  <div class="container">
    <div class="fl glyphicon glyphicon-home sy"><a href="./index.php">蘑菇街首页</a></div>
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li><a href="#"> <span class="glyphicon glyphicon-th-list" style="color:#666666;font-size:10px"></span> 我的订单</a></li>

          <li><a href="#"> <span class="glyphicon glyphicon-shopping-cart" style="color:#FF4466;font-size:10px"></span> 购物车</a></li>

          <li><a href="#">客户服务</a></li>

          <li class="dropdown">
             <a href="<?php echo URL ?>login.php" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">    <span class="glyphicon glyphicon-home" style="color:#E92E22;font-size:15px"></span> 我的小店 <span class="caret"></span></a>
