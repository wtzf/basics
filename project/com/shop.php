    ...
    <div class="row mt50">
        ...
        <div class="col-md-8 pull-right">
            <div class="row">
                ...
                <h4><?php echo $list['msg'] ?></h4>
            </div>
            <div class="row">
                <h1 class="col-md-3 red">
                    <span class="glyphicon glyphicon-yen red"></span>
                    <?php echo $list['price'] ?>
                </h1>
                <h1 class="col-md-3 col-md-offset-1 h2">
            ...
            <form action="./com/cartdo.php" method="get">
                ...
                <div class="row mt10">
                    ...
                    <span class="col-md-2 h4">库存: <?php echo $list['stock'] ?></span>
                    <span class="col-md-4 h4">销量: <?php echo $list['sale'] ?></span>
                </div>
                <div class="row mt30">
