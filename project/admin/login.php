...
<div class="conatiner mt50">
    ...
    <h1 class="text-center mt50 h1">后 台 登 录</h1>
    <hr>
    ...
    <form action="./logindo.php" method="post" class="form-horizontal col-md-4 col-md-offset-4">
        ...
        <div class="form-group">
            <div class="col-md-12">
              <button type="submit" class="btn btn-primary btn-lg btn-block  mt30">登 录</button>
              <a href="../index.php" class="pull-right  mt30 h2">返回首页</a>
            </div>
        </div>
